...
from ..tm_legal import tm_sound_tags, tm_lowercase_terms, tm_speaker_caps, tm_double_dash, tm_spoken_punct
...
register(Profile(
    ...
    scanners=(timestamps, *LEGAL_SCANNERS, legal_terms,
              tm_sound_tags, tm_lowercase_terms, tm_speaker_caps, tm_double_dash, tm_spoken_punct),
